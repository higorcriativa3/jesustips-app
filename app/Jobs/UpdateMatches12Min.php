...
class UpdateMatches12Min
{
  ...
  public function __invoke() {
    ...
    $url = 'https://api.b365api.com/v2/events/ended?sport_id=1&league_id=22537&day='.$yesterday.'&token=91390-4sDwuMJTtIhuPJ&page=';
    ...
    do{
        ...
        foreach($response['results'] as $key => $match) {
            ...
            try{
                ...
                file_put_contents(base_path("storage/app/pageControl12Min.txt"), $page . " - " . $yesterday . " - " . $e->getMessage());
                return 0;            }
        }
